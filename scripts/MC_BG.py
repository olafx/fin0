...
plt.ylabel(R'$X_t$')
plt.tight_layout()
if plot_save: plt.savefig(Path.cwd()/'out'/'MC_BG_1.png', bbox_inches='tight', dpi=400)
plt.figure(2)
plt.xlim(0, T)
plt.plot(t, S.T)
plt.xlabel(R'$t$')
plt.ylabel(R'$S_t$')
plt.tight_layout()
if plot_save: plt.savefig(Path.cwd()/'out'/'MC_BG_2.png', bbox_inches='tight', dpi=400)
else: plt.show()
